...
# ============================================================
DATA_PATH = Path(r"\\s7data\beams46\7IDC\Sargent\03_2026\1p68ev_film_unaged1") # Path to directory containing TIFF files
MASK_FILE = Path(r"C:\Users\lheald\Documents\Guzelturk_Lab\TRXRDPython\testdata\mask_2021_dec.tif") # Path to mask file
SCAN_NAME = "550nm_2_re" # Prefix in file name to identify relevant files, e.g. "550nm_re" etc.
BACKGROUND_PATH = Path(r"\\s7data\beams46\7IDC\Sargent\03_2026\GlassITORef\ITO_CoR1_2.5-deg_theta3.781samz00004_224.tif")
SAVE_PATH = Path(r"C:\Users\lheald\Documents\Guzelturk_Lab\Sargent_Processed_Data") # Path to directory where processed data will be saved, e.g. as .h5 file
...
NORM_MIN = 3.15 # Minimum value for normalization, values below this will be set to this value before normalization, e.g. 0.5 or None for no minimum threshold
NORM_MAX = 3.35 # Maximum value for normalization, values above this will be set to this value before normalization, e.g. 1.0 or None for no maximum threshold
...
DISTANCE = 0.173                  # m, sample-to-detector distance
WAVELENGTH = 0.6888009236185533e-10          # m

# Detector orientation
TILT_ANGLE = np.deg2rad(-0.2)               # rad
TILT_PLANE_ROTATION = np.deg2rad(0)      # rad
...
# ============================================================
COMPOSITION = "Cs0.097Pb1C0.904N1.679I1.798Br1.105Cl0.097" # Sample composition for form factor calculation, e.g. "BaTiO3" or None for no form factor correction
